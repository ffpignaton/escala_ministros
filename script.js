...
<div class="actions">
<button class="small-btn" onclick="editarMinistro('${doc.id}','${m.nome}','${m.fone || ""}')">Editar</button>
<button class="small-btn" onclick="deletarMinistro('${doc.id}')">Excluir</button>
</div>
</div>
`;
...
<td>
<button class="small-btn" onclick="editarEscala('${doc.id}','${e.data}','${e.hora}')">Editar</button>
<button class="small-btn" onclick="deletarEscala('${doc.id}')">Excluir</button>
</td>
</tr>
`;
